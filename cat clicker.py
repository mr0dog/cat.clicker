...
pygame.display.set_caption("Cat Clicker")#sets the window title
...
CatPic2 = pygame.image.load("really.png")
CatRect2 = CatPic2.get_rect(topleft=(100,100))
...
Click = pygame.mixer.Sound('boom.mp3')
